$(function () {
    //InlinePartialViewSubmit("UpdateDocForm", "btnOrgUnitUpdate", "divEdit");
    Sweet2EditViewSubmit("UpdateDocForm", "btnOrgUnitUpdate");
});

function Sweet2EditViewSubmit(formId, buttonId) {
